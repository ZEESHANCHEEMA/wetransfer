...
export const styles = StyleSheet.create({
  ...
  buttonText: { color: colors.white, fontWeight: '700', textTransform: 'lowercase' },
  ...
  codeInput: { width: 46, height: 58, borderRadius: 14, borderWidth: 2, borderColor: colors.border, backgroundColor: colors.white, textAlign: 'center', fontSize: 22, color: colors.text },
  ...
  contactNameActive: { color: colors.white },
  contactPhoneActive: { color: alpha.onPrimarySoft },
  avatar: { width: 48, height: 48, borderRadius: 24 },
  flexOne: { flex: 1 },
  modalOverlay: { flex: 1, backgroundColor: alpha.overlay, justifyContent: 'center', padding: 20 },
  ...
  promoTitle: { color: colors.white, fontWeight: '700', textTransform: 'lowercase' },
  promoSubtitle: { color: alpha.dockTextOnPrimary, fontSize: 12, textTransform: 'lowercase' },
  ...
  qrPlaceholder: { height: 180, borderRadius: 20, backgroundColor: colors.white, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center' },
  ...
  bigStat: { fontSize: 22, fontWeight: '700', color: colors.textMuted },
  dockWrap: { position: 'absolute', left: 0, right: 0, bottom: 0, paddingHorizontal: 20 },
  dock: {
    flexDirection: 'row',
    justifyContent: 'space-around',
    alignItems: 'flex-end',
    gap: 8,
    backgroundColor: alpha.dockBackground,
    borderRadius: 22,
    borderWidth: 1,
  ...
  dockItem: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 4, paddingVertical: 8, borderRadius: 18 },
  dockItemActive: { backgroundColor: 'transparent' },
  dockIcon: { color: colors.textSoft },
  dockIconActive: { color: colors.primary },
  dockText: { color: colors.textSoft, fontSize: 10, fontWeight: '600', textTransform: 'lowercase' },
  dockTextActive: { color: colors.primary, fontWeight: '700' },
  ...
  addPillText: { color: colors.white, fontSize: 13, textTransform: 'lowercase' },
  ...
  fullButtonText: { color: colors.white, fontWeight: '700', textTransform: 'lowercase' },
