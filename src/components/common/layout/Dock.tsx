...
export const Dock = () => {
  ...
  const indicatorStyle = useAnimatedStyle(() => {
    ...
    return { transform: [{ translateX: x }], width: tabWidth.value };
  }, [activeIndex]);
      ...
      <View
        ...
        {tabs.map((tab) => (
          <Pressable
            ...
            <tab.Icon size={22} strokeWidth={1.6} color={activeId === tab.id ? styles.dockIconActive.color : styles.dockIcon.color} />
